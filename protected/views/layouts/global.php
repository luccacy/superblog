...
<head>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/notifications.css" />
...
<?php $this->renderPartial('//element/header'); ?>
<?php echo $content; ?>

<footer>
    Copyright &copy; <?php echo date('Y'); ?> author: zhouyu &nbsp; All Rights Reserved. <?php //echo Yii::powered(); ?>
</footer>
</body>
</html>